local Vehicles = {
    ...
    { model = 'blista',          name = 'Blista',                        brand = 'Dinka',           price = 2521,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'brioso',          name = 'Brioso R/A',                    brand = 'Grotti',          price = 1750,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'club',            name = 'Club',                          brand = 'BF',              price = 2521,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'dilettante',      name = 'Dilettante',                    brand = 'Karin',           price = 2100,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'dilettante2',     name = 'Dilettante Patrol',             brand = 'Karin',           price = 2850,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'kanjo',           name = 'Blista Kanjo',                  brand = 'Dinka',           price = 1500,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi2',           name = 'Issi',                          brand = 'Weeny',           price = 2950,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi3',           name = 'Issi Classic',                  brand = 'Weeny',           price = 2786,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi4',           name = 'Issi Arena',                    brand = 'Weeny',           price = 2750,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi5',           name = 'Issi Future Shock',             brand = 'Weeny',           price = 2900,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi6',           name = 'Issi Nightmare',                brand = 'Weeny',           price = 2335,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'panto',           name = 'Panto',                         brand = 'Benefactor',      price = 3000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'prairie',         name = 'Prairie',                       brand = 'Bollokan',        price = 2400,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'rhapsody',        name = 'Rhapsody',                      brand = 'Declasse',        price = 1786,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'brioso2',         name = 'Brioso 300',                    brand = 'Grotti',          price = 2100,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'weevil',          name = 'Weevil',                        brand = 'BF',              price = 1200,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi7',           name = 'Issi Sport',                    brand = 'Weeny',           price = 1959,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'blista2',         name = 'Blista Compact',                brand = 'Dinka',           price = 1764,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'blista3',         name = 'Blista Go Go Monkey',           brand = 'Dinka',           price = 1750,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'brioso3',         name = 'Brioso 300 Widebody',           brand = 'Grotti',          price = 2800,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'boor',            name = 'Boor',                          brand = 'Karin',           price = 2600,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'volvom',            name = 'Volvom',                          brand = 'Volvom',           price = 5132,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'cls2015',           name = 'cls2015',                         brand = 'cls2015',          price = 2735,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'e60',               name = 'e60',                             brand = 'e60',              price = 6248,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'g65amg',            name = 'g65amg',                          brand = 'g65amg',           price = 1586,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'passatb3',          name = 'passatb3',                        brand = 'passatb3',         price = 3310,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'R50',               name = 'R50',                             brand = 'R50',              price = 2854,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'rs7c8',             name = 'rs7c8',                           brand = 'rs7c8',            price = 4695,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'SubaruSTI7',        name = 'SubaruSTI7',                      brand = 'SubaruSTI7',       price = 5538,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'zx10r',             name = 'zx10r',                           brand = 'zx10r',            price = 3199,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'gtr',               name = 'gtr',                             brand = 'gtr',              price = 1750,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'alpinab7BLACKEDITION', name = 'alpinab7BLACKEDITION',         brand = 'alpinab7BLACKEDITION', price = 6011, category = 'imports',     type = 'automobile', shop = 'pdm' },
    { model = 'rs6rabt20',         name = 'rs6rabt20',                       brand = 'rs6rabt20',        price = 4503,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'benze55',           name = 'benze55',                         brand = 'benze55',          price = 1897,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'rsq8mans',          name = 'rsq8mans',                        brand = 'rsq8mans',         price = 3659,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'gcb23x7',           name = 'gcb23x7',                         brand = 'gcb23x7',          price = 2491,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'm3s',               name = 'm3s',                             brand = 'm3s',              price = 5982,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'm5',                name = 'm5',                              brand = 'm5',               price = 2066,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'm5abflug',          name = 'm5abflug',                        brand = 'm5abflug',         price = 4290,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = 'm5e61przemo',       name = 'm5e61przemo',                     brand = 'm5e61przemo',      price = 3561,   category = 'imports',       type = 'automobile', shop = 'pdm' },
    { model = '2019M5',            name = '2019M5',                          brand = '2019M5',           price = 5368,   category = 'imports',       type = 'automobile', shop = 'pdm' },    
    --- Sedans (1)
    { model = 'asea',            name = 'Asea',                          brand = 'Declasse',        price = 1200,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'asterope',        name = 'Asterope',                      brand = 'Karin',           price = 2700,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'cog55',           name = 'Cognoscenti 55',                brand = 'Enus',            price = 2900,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'cognoscenti',     name = 'Cognoscenti',                   brand = 'Enus',            price = 2500,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'emperor',         name = 'Emperor',                       brand = 'Albany',          price = 1800,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'fugitive',        name = 'Fugitive',                      brand = 'Cheval',          price = 2200,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'glendale',        name = 'Glendale',                      brand = 'Benefactor',      price = 2000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'glendale2',       name = 'Glendale Custom',               brand = 'Benefactor',      price = 2800,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'ingot',           name = 'Ingot',                         brand = 'Vulcar',          price = 1750,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'intruder',        name = 'Intruder',                      brand = 'Karin',           price = 2650,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'premier',         name = 'Premier',                       brand = 'Declasse',        price = 2100,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'primo',           name = 'Primo',                         brand = 'Albany',          price = 2350,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'primo2',          name = 'Primo Custom',                  brand = 'Albany',          price = 2600,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'regina',          name = 'Regina',                        brand = 'Dundreary',       price = 1500,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'stafford',        name = 'Stafford',                      brand = 'Enus',            price = 2950,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'stanier',         name = 'Stanier',                       brand = 'Vapid',           price = 1900,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'stratum',         name = 'Stratum',                       brand = 'Zirconium',       price = 2400,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'stretch',         name = 'Stretch',                       brand = 'Dundreary',       price = 3000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'superd',          name = 'Super Diamond',                 brand = 'Enus',            price = 2300,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'surge',           name = 'Surge',                         brand = 'Cheval',          price = 1950,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'tailgater',       name = 'Tailgater',                     brand = 'Obey',            price = 2900,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'warrener',        name = 'Warrener',                      brand = 'Vulcar',          price = 1700,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'washington',      name = 'Washington',                    brand = 'Albany',          price = 2600,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'tailgater2',      name = 'Tailgater S',                   brand = 'Obey',            price = 2850,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'cinquemila',      name = 'Lampadati',                     brand = 'Cinquemila',      price = 2750,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'iwagen',          name = 'Obey',                          brand = 'I-Wagen',         price = 3000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'astron',          name = 'Astron',                        brand = 'Pfister',         price = 2950,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'baller7',         name = 'Baller ST',                     brand = 'Gallivanter',     price = 2850,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'comet7',          name = 'Comet',                         brand = 'S2 Cabrio',       price = 2650,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'deity',           name = 'Deity',                         brand = 'Enus',            price = 2700,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'jubilee',         name = 'Jubilee',                       brand = 'Enus',            price = 2550,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'oracle',          name = 'Oracle',                        brand = 'Übermacht',       price = 2400,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'schafter2',       name = 'Schafter',                      brand = 'Benefactor',      price = 2200,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'warrener2',       name = 'Warrener HKR',                  brand = 'Vulcar',          price = 2900,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'rhinehart',       name = 'Rhinehart',                     brand = 'Übermacht',       price = 3000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'eudora',          name = 'Eudora',                        brand = 'Willard',         price = 2500,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'asterope2',       name = 'Asterope GZ',                   brand = 'Karin',           price = 2700,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'impaler5',        name = 'Impaler SZ',                    brand = 'Declasse',        price = 3000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },    
    --- SUV (2)
    ...
    { model = 'baller5',         name = 'Baller LE (Armored)',           brand = 'Gallivanter',     price = 2800,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'baller6',         name = 'Baller LE LWB (Armored)',       brand = 'Gallivanter',     price = 2900,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'contender',       name = 'Contender',                     brand = 'Vapid',           price = 2000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'fq2',             name = 'FQ2',                           brand = 'Fathom',          price = 1800,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'novak',           name = 'Novak',                         brand = 'Lampadati',       price = 2500,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'serrano',         name = 'Serrano',                       brand = 'Benefactor',      price = 2800,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'toros',           name = 'Toros',                         brand = 'Pegassi',         price = 2900,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'xls',             name = 'XLS',                           brand = 'Benefactor',      price = 1700,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'granger2',        name = 'Granger 3600LX',                brand = 'Declasse',        price = 2900,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'patriot3',        name = 'Patriot Military',              brand = 'Mil-Spec',        price = 2900,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'aleutian',        name = 'Aleutian',                      brand = 'Vapid',           price = 2900,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'baller8',         name = 'Baller ST-D',                   brand = 'Gallivanter',     price = 2900,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'cavalcade3',      name = 'Cavalcade XL',                  brand = 'Albany',          price = 2900,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'dorado',          name = 'Dorado',                        brand = 'Bravado',         price = 2900,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'vivanite',        name = 'Vivanite',                      brand = 'Karin',           price = 2900,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'castigator',      name = 'Castigator',                    brand = 'Canis',           price = 2900,   category = 'suvs',           type = 'automobile', shop = 'pdm' },    
    --- Coupes (3)
    { model = 'cogcabrio',       name = 'Cognoscenti Cabrio',            brand = 'Enus',            price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'exemplar',        name = 'Exemplar',                      brand = 'Dewbauchee',      price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'f620',            name = 'F620',                          brand = 'Ocelot',          price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'felon',           name = 'Felon',                         brand = 'Lampadati',       price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'felon2',          name = 'Felon GT',                      brand = 'Lampadati',       price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'jackal',          name = 'Jackal',                        brand = 'Ocelot',          price = 2500,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'oracle2',         name = 'Oracle XS',                     brand = 'Übermacht',       price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'sentinel',        name = 'Sentinel',                      brand = 'Übermacht',       price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'sentinel2',       name = 'Sentinel XS',                   brand = 'Übermacht',       price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'windsor',         name = 'Windsor',                       brand = 'Enus',            price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'windsor2',        name = 'Windsor Drop',                  brand = 'Enus',            price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'zion',            name = 'Zion',                          brand = 'Übermacht',       price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'zion2',           name = 'Zion Cabrio',                   brand = 'Übermacht',       price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'previon',         name = 'Previon',                       brand = 'Karin',           price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'champion',        name = 'Champion',                      brand = 'Dewbauchee',      price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'futo',            name = 'Futo',                          brand = 'Karin',           price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'sentinel3',       name = 'Sentinel Classic',              brand = 'Übermacht',       price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'kanjosj',         name = 'Kanjo SJ',                      brand = 'Dinka',           price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'postlude',        name = 'Postlude',                      brand = 'Dinka',           price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'tahoma',          name = 'Tahoma Coupe',                  brand = 'Declasse',        price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'broadway',        name = 'Broadway',                      brand = 'Classique',       price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'fr36',            name = 'FR36',                          brand = 'Fathom',          price = 2900,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    --- Muscle (4)
    ...
    { model = 'chino',           name = 'Chino',                         brand = 'Vapid',           price = 2500,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'chino2',          name = 'Chino Luxe',                    brand = 'Vapid',           price = 2800,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'clique',          name = 'Clique',                        brand = 'Vapid',           price = 2000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'coquette3',       name = 'Coquette BlackFin',             brand = 'Invetero',        price = 1800,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'deviant',         name = 'Deviant',                       brand = 'Schyster',        price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'dominator',       name = 'Dominator',                     brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'dominator2',      name = 'Pißwasser Dominator',           brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'dominator3',      name = 'Dominator GTX',                 brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'dominator4',      name = 'Dominator Arena',               brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'dominator7',      name = 'Dominator ASP',                 brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'dominator8',      name = 'Dominator GTT',                 brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'dukes',           name = 'Dukes',                         brand = 'Imponte',         price = 2350,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'dukes2',          name = 'Duke O'Death',                  brand = 'Imponte',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'dukes3',          name = 'Beater Dukes',                  brand = 'Imponte',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'faction3',        name = 'Faction Custom Donk',           brand = 'Willard',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'ellie',           name = 'Ellie',                         brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'gauntlet',        name = 'Gauntlet',                      brand = 'Bravado',         price = 2850,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'gauntlet2',       name = 'Redwood Gauntlet',              brand = 'Bravado',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'gauntlet3',       name = 'Classic Gauntlet',              brand = 'Bravado',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'gauntlet4',       name = 'Gauntlet Hellfire',             brand = 'Bravado',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'gauntlet5',       name = 'Gauntlet Classic Custom',       brand = 'Bravado',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'hermes',          name = 'Hermes',                        brand = 'Albany',          price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'hotknife',        name = 'Hotknife',                      brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'hustler',         name = 'Hustler',                       brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'impaler',         name = 'Impaler',                       brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'impaler2',        name = 'Impaler Arena',                 brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'impaler3',        name = 'Impaler Future Shock',          brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'impaler4',        name = 'Impaler Nightmare',             brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'imperator',       name = 'Imperator Arena',               brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'imperator2',      name = 'imperator Future Shock',        brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'imperator3',      name = 'Imperator Nightmare',           brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'lurcher',         name = 'Lurcher',                       brand = 'Bravado',         price = 2100,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'nightshade',      name = 'Nightshade',                    brand = 'Imponte',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'phoenix',         name = 'Phoenix',                       brand = 'Imponte',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'ruiner2',         name = 'Ruiner 2000',                   brand = 'Imponte',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'slamvan2',        name = 'Lost Slam Van',                 brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'slamvan3',        name = 'Slam Van Custom',               brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'stalion',         name = 'Stallion',                      brand = 'Declasse',        price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'stalion2',        name = 'Stallion Burgershot',           brand = 'Declasse',        price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'tampa',           name = 'Tampa',                         brand = 'Declasse',        price = 2450,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'tulip',           name = 'Tulip',                         brand = 'Declasse',        price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'vamos',           name = 'Vamos',                         brand = 'Declasse',        price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'vigero',          name = 'Vigero',                        brand = 'Declasse',        price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'yosemite2',       name = 'Yosemite Drift',                brand = 'Declasse',        price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'buffalo4',        name = 'Buffalo STX',                   brand = 'Bravado',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'tampa2',          name = 'Drift Tampa',                   brand = 'Declasse',        price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'ruiner4',         name = 'Ruiner ZZ-8',                   brand = 'Imponte',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'vigero2',         name = 'Vigero ZX',                     brand = 'Declasse',        price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'weevil2',         name = 'Weevil Custom',                 brand = 'BF',              price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'buffalo5',        name = 'Buffalo EVX',                   brand = 'Bravado',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'tulip2',          name = 'Tulip M-100',                   brand = 'Declasse',        price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'clique2',         name = 'Clique Wagon',                  brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'brigham',         name = 'Brigham',                       brand = 'Albany',          price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'greenwood',       name = 'Greenwood',                     brand = 'Bravado',         price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'dominator9',      name = 'Dominator GT',                  brand = 'Vapid',           price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'impaler6',        name = 'Impaler LX',                    brand = 'Declasse',        price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'vigero3',         name = 'Vigero ZX Convertible',         brand = 'Declasse',        price = 3000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    --- Sports Classic (5)
    { model = 'ardent',          name = 'Ardent',                        brand = 'Ocelot',          price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'btype',           name = 'Roosevelt',                     brand = 'Albany',          price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'btype2',          name = 'Franken Stange',                brand = 'Albany',          price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'btype3',          name = 'Roosevelt Valor',               brand = 'Albany',          price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'casco',           name = 'Casco',                         brand = 'Lampadati',       price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'deluxo',          name = 'Deluxo',                        brand = 'Imponte',         price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    ...
    { model = 'feltzer3',        name = 'Stirling GT',                   brand = 'Benefactor',      price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'gt500',           name = 'GT500',                         brand = 'Grotti',          price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'infernus2',       name = 'Infernus Classic',              brand = 'Pegassi',         price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'jb700',           name = 'JB 700',                        brand = 'Dewbauchee',      price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'jb7002',          name = 'JB 700W',                       brand = 'Dewbauchee',      price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'mamba',           name = 'Mamba',                         brand = 'Declasse',        price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'michelli',        name = 'Michelli GT',                   brand = 'Lampadati',       price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'monroe',          name = 'Monroe',                        brand = 'Pegassi',         price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    ...
    { model = 'peyote3',         name = 'Peyote Custom',                 brand = 'Vapid',           price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'pigalle',         name = 'Pigalle',                       brand = 'Lampadati',       price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'rapidgt3',        name = 'Rapid GT Classic',              brand = 'Dewbauchee',      price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'retinue',         name = 'Retinue',                       brand = 'Vapid',           price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'retinue2',        name = 'Retinue MKII',                  brand = 'Vapid',           price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'savestra',        name = 'Savestra',                      brand = 'Annis',           price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'stinger',         name = 'Stinger',                       brand = 'Grotti',          price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'stingergt',       name = 'Stinger GT',                    brand = 'Grotti',          price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'stromberg',       name = 'Stromberg',                     brand = 'Ocelot',          price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'swinger',         name = 'Swinger',                       brand = 'Ocelot',          price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'torero',          name = 'Torero',                        brand = 'Pegassi',         price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    ...
    { model = 'turismo2',        name = 'Turismo Classic',               brand = 'Grotti',          price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'viseris',         name = 'Viseris',                       brand = 'Lampadati',       price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'z190',            name = '190Z',                          brand = 'Karin',           price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'ztype',           name = 'Z-Type',                        brand = 'Truffade',        price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'zion3',           name = 'Zion Classic',                  brand = 'Übermacht',       price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'cheburek',        name = 'Cheburek',                      brand = 'Rune',            price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'toreador',        name = 'Toreador',                      brand = 'Pegassi',         price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'peyote2',         name = 'Peyote Gasser',                 brand = 'Vapid',           price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'coquette2',       name = 'Coquette Classic',              brand = 'Invetero',        price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'envisage',        name = 'Envisage',                      brand = 'Bollokan',        price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'driftnebula',     name = 'Nebula Turbo',                  brand = 'Vulcar',          price = 3000,    category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    --- Sports (6)
